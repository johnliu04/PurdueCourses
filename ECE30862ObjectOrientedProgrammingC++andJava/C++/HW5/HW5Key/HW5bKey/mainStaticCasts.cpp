...
int main() {
   ...
   // There is no way this can be correct (no ISA relation between Student 
   // and Faculty, so a compile time error will be issued by C++
   ...
   // program terminates with this statement -- there is no valid entry for
   // getGPA in the Person class.
   s->getGPA( );
